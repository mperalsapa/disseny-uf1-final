                    ...
                    <div class="col row p-0 me-0 w-100">
                        ...
                        <div class="d-flex p-0">
                            <div class="col-3 mb-3 p-0 ps-3">
                                <a href="edit-activity.php" class="card">
                            ...
                            <div class="col-3 mb-3 p-0 ps-3">
                                <a href="new-activity.php" class="card bg-transparent h-100 d-flex justify-content-center align-items-center" style="border: .25rem dotted #fdfdfd;">
                            ...
                            echo "  <div class=\"col-3 mb-3 p-0 ps-3\">
                                        <a href=\"activity.php\" class=\"card\">
                                            ...
                                            <div class=\"card-body\" style=\"height: 15rem;\">
                                                ...
                                                <div class=\"h-50 d-flex align-items-center flex-column-reverse\">
                                                    <span class=\"order-last\">99 places disponibles</span>
                                                    <div class=\"d-flex justify-content-between w-100 mt-3\">
                                                        <button name=\"\" id=\"\" class=\"btn btn-secondary fs-5\" h6ef=\"#\" role=\"button\">Editar</button>
                                                        <button name=\"\" id=\"\" class=\"btn btn-secondary fs-5\" h6ef=\"#\" role=\"button\">Esborrar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
